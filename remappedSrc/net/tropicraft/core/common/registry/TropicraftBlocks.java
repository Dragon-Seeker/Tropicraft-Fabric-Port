...
public class TropicraftBlocks {
    ...
    public static final TropicOreBlock MANGANESE_ORE = registerBlock("manganese_ore", Builder.OreBlock(MaterialColor.COLOR_GRAY));
    public static final TropicOreBlock SHAKA_ORE = registerBlock("shaka_ore", Builder.OreBlock(MaterialColor.COLOR_GRAY));
    public static final TropicOreBlock EUDIALYTE_ORE = registerBlock("eudialyte_ore", Builder.OreBlock(MaterialColor.COLOR_GRAY, 2));
    public static final TropicOreBlock AZURITE_ORE = registerBlock("azurite_ore", Builder.OreBlock(MaterialColor.COLOR_GRAY, 2));
    public static final TropicOreBlock ZIRCON_ORE = registerBlock("zircon_ore", Builder.OreBlock(MaterialColor.COLOR_GRAY, 1));
    ...
    public static FabricBlockSettings FlowerPot = FabricBlockSettings.copyOf(BAMBOO_BUNDLE).instabreak().noOcclusion();

    public static final Block BAMBOO_FLOWER_POT = registerBlock("bamboo_flower_pot", Builder.BambooPot(Blocks.AIR));

    private static FabricBlockSettings FLOWERS_SETTINGS = FabricBlockSettings.of(Material.PLANT).sound(SoundType.GRASS).instabreak().noCollission();
