...
public class HomeTreeStructure extends StructureFeature<JigsawConfiguration> {
    ...
    @Override
    protected boolean shouldStartAt(ChunkGenerator generator, BiomeSource biomes, long seed, WorldgenRandom random, int chunkX, int chunkZ, Biome biome, ChunkPos startChunkPos, JigsawConfiguration config) {
    ...
    public static class Start extends StructureStart<JigsawConfiguration> {
        ...
        @Override
        public void init(RegistryAccess registries, ChunkGenerator generator, StructureManager templates, int chunkX, int chunkZ, Biome biome, JigsawConfiguration config) {
