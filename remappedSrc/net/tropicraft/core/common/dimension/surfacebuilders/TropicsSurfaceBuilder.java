...
public class TropicsSurfaceBuilder extends SurfaceBuilder<TropicsSurfaceBuilder.Config> {
    ...
    @Override
    public void generate(Random random, ChunkAccess chunk, Biome biome, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, Config config) {
