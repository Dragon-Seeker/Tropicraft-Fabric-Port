...
public class TropicraftSpecialRenderHelper {
    ...
    public void renderMask(PoseStack stack, VertexConsumer buffer, int maskIndex, int packedLightIn, int overlayLightIn) { //IVertexBuilder
        stack.pushPose();
    ...
    public void renderFish(final PoseStack stack, final VertexConsumer buffer, final int index, final int packedLightIn, final int overlayLightIn) { //IVertexBuilder
    ...
    public static void vertex(VertexConsumer bufferIn, PoseStack ms, double x, double y, double z, float red, float green, float blue, float alpha, float texU, float texV, Direction normal, int packedLight, int packedOverlay) { //IVertexBuilder
    ...
    public static void popper(float f, float f1, float f2, float f3, float f1shifted, float f3shifted, float layerHeight, PoseStack stack, VertexConsumer buffer, int packedLightIn, int overlayLightIn, float red, float green, float blue, float alpha) { //IVertexBuilder
        float f4 = 1.0F;
    ...
    public static void popper(float f, float f1, float f2, float f3, float f1shifted, float f3shifted, float layerHeight, PoseStack stack, VertexConsumer buffer, int packedLightIn, int overlayLightIn) { //IVertexBuilder
        popper(f, f1, f2, f3, f1shifted, f3shifted, layerHeight, stack, buffer, packedLightIn, overlayLightIn, 1, 1, 1, 1);
    }

    public static void popper(float f, float f1, float f2, float f3, float f1shifted, float f3shifted, PoseStack stack, VertexConsumer buffer, int packedLightIn, int overlayLightIn) { //IVertexBuilder
