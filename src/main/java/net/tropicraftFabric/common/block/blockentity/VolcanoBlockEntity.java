...
import net.tropicraftFabric.common.TropicsConfigs;
import net.tropicraftFabric.common.dimension.chunk.VolcanoGenerator;
...
import net.tropicraftFabric.common.volcano.VolcanoState;
...
public class VolcanoBlockEntity extends BlockEntity implements Tickable
{
	...
	public void onDataPacket(ClientConnection net, BlockEntityUpdateS2CPacket pkt) {
		fromTag(getCachedState(), pkt.getNbt());
	}
	 */
