...
public class TropicraftCarvers {
    ...
    public static final TropicsUnderwaterCanyonCarver UNDERWATER_CANYON = register("underwater_canyon", new TropicsUnderwaterCanyonCarver(ProbabilityConfig.CODEC));
