...
public class TropicraftFeatures {
    ...
    public static final ConfiguredFeature<?, ?> NORMAL_PALM_TREE_CONFIGURED = registerConfiguredFeature("normal_palm_tree_configured", TropicraftFeatures.NORMAL_PALM_TREE.configure(DefaultFeatureConfig.INSTANCE).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(0, 0.08F, 1))));
    public static final ConfiguredFeature<?, ?> CURVED_PALM_TREE_CONFIGURED = registerConfiguredFeature("curved_palm_tree_configured", TropicraftFeatures.CURVED_PALM_TREE.configure(DefaultFeatureConfig.INSTANCE).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(0, 0.08F, 1))));
    public static final ConfiguredFeature<?, ?> LARGE_PALM_TREE_CONFIGURED = registerConfiguredFeature("large_palm_tree_configured", TropicraftFeatures.LARGE_PALM_TREE.configure(DefaultFeatureConfig.INSTANCE).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(0, 0.08F, 1))));
