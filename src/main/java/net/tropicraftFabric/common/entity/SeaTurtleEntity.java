...
import net.tropicraftFabric.common.entity.egg.SeaTurtleEggEntity;
import net.tropicraftFabric.common.registry.TropicraftEntities;
import net.tropicraftFabric.common.registry.TropicraftEntityAttributes;
import net.tropicraftFabric.mixins.SeaTurtleAccessor;
import net.tropicraftFabric.mixins.SeaTurtleInvoker;
