...
public class TropicsCanyonCarver extends RavineCarver {
    ...
    @Override
    public boolean carve(Chunk chunk, Function<BlockPos, Biome> biomePos, Random rand, int seaLevel, int chunkXOffset, int chunkZOffset, int chunkX, int chunkZ, BitSet carvingMask, ProbabilityConfig config) {
