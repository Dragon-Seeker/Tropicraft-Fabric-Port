...
public class FishingBobberEntity extends Entity {
   ...
   public FishingBobberEntity(EntityKoaBase p_i50220_1_, Level p_i50220_2_, int p_i50220_3_, int p_i50220_4_) {
      ...
      float tempYaw = (float)(Mth.atan2(Vector3d.x, Vector3d.z) * (double)(180F / (float)Math.PI));
      float tempPitch = (float)(Mth.atan2(Vector3d.y, Math.sqrt(distanceToSqr(Vector3d))) * (double)(180F / (float)Math.PI));
   ...
   private void updateRotation() {
      Vec3 Vector3d = this.getDeltaMovement();
      double f = Math.sqrt(distanceToSqr(Vector3d));
      float tempYaw1 = (float)(Mth.atan2(Vector3d.x, Vector3d.z) * (double)(180F / (float)Math.PI));
      this.setYRot(tempYaw1);
