...
public class BambooItemFrameEntityRenderer extends EntityRenderer<BambooItemFrameEntity> {
    public static final ModelIdentifier LOCATION_MODEL = new ModelIdentifier(Registry.ITEM.getId(TropicItems.BAMBOO_ITEM_FRAME), "map=false");
    private static final ModelIdentifier LOCATION_MODEL_MAP = new ModelIdentifier(Registry.ITEM.getId(TropicItems.BAMBOO_ITEM_FRAME), "map=true");
    private final MinecraftClient mc = MinecraftClient.getInstance();
    private final ItemRenderer itemRenderer;

    public BambooItemFrameEntityRenderer(EntityRenderDispatcher dispatcher, ItemRenderer ItemRenderer) {
        super(dispatcher);
    ...
    public Vec3d getRenderOffset(BambooItemFrameEntity entityIn, float partialTicks) {
