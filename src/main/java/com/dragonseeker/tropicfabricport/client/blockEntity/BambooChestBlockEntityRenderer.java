package com.dragonseeker.tropicfabricport.client.blockEntity;
...
public class BambooChestBlockEntityRenderer<T extends BlockEntity & ChestAnimationProgress> extends BlockEntityRenderer<TropicBambooChestBlockEntity> {
    ...
    private static ItemStack stack = new ItemStack(TropicItems.BAMBOO_CHEST, 1);
    ...
    static {
        ...
        bambooChestLayer = new RenderLayer[] {
                RenderLayer.getEntityCutout(new Identifier(Tropicfabricport.MOD_ID, "textures/entity/chest/" + Registry.BLOCK.getId(TropicBlocks.BAMBOO_CHEST).getPath() + "_normal.png")),
                RenderLayer.getEntityCutout(new Identifier(Tropicfabricport.MOD_ID, "textures/entity/chest/" + Registry.BLOCK.getId(TropicBlocks.BAMBOO_CHEST).getPath() + "_left.png")),
                RenderLayer.getEntityCutout(new Identifier(Tropicfabricport.MOD_ID, "textures/entity/chest/" + Registry.BLOCK.getId(TropicBlocks.BAMBOO_CHEST).getPath() + "_right.png"))
        };
    }
