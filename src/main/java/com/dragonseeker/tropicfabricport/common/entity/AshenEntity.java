...
import com.dragonseeker.tropicfabricport.common.entity.ai.ashen.AIAshenChaseAndPickupLostMask;
import com.dragonseeker.tropicfabricport.common.entity.ai.ashen.AIAshenShootDart;
import com.dragonseeker.tropicfabricport.common.entity.ai.ashen.EntityAIMeleeAndRangedAttack;
...
import com.dragonseeker.tropicfabricport.common.item.BlowGunItem;
...
public class AshenEntity extends TropicraftCreatureEntity implements RangedAttackMob {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable NbtCompound entityNbt) {
        setStackInHand(Hand.OFF_HAND, new ItemStack(TropicItems.BLOW_GUN));
        setStackInHand(Hand.MAIN_HAND, new ItemStack(TropicItems.DAGGER));
    ...
    protected void registerAttributes() {
        ...
        FabricDefaultAttributeRegistry.register(AshenEntity, );

        getAttributes().registerAttribute(EntityAttributes.GENERIC_ATTACK_DAMAGE);
    ...
    public void dropMask() {
        ...
        maskToTrack = new AshenMaskEntity(TropicEntities.ASHEN_MASK, world);
