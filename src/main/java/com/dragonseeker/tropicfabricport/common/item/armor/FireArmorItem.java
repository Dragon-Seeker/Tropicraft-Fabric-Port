...
import com.dragonseeker.tropicfabricport.common.item.ArmorMaterials;
...
//
    ...
    public void clientTick(PlayerEntity player) {
        ...
        if (this == TropicItems.FIRE_BOOTS) {
        ...
        else if (this == TropicItems.FIRE_LEGGINGS) {
            ParticleEffect particle = ParticleTypes.FLAME;
        ...
        } else if (this == TropicItems.FIRE_CHESTPLATE) {
            float look = -180F;
            double dist = 0.5F;
        ...
        } else if (this == TropicItems.FIRE_HELMET) {
            float look = -180F;
            double dist = 0.5F;
