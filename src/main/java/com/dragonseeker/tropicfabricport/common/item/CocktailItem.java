...
import com.dragonseeker.tropicfabricport.common.drinks.ColorMixer;
import com.dragonseeker.tropicfabricport.common.drinks.Drink;
import com.dragonseeker.tropicfabricport.common.drinks.Ingredient;
...
public class CocktailItem extends Item implements IColoredItem {//implements IColoredItem {//ItemColorProvider
	...
	public static ItemStack makeCocktail(final List<ItemStack> itemStacks) {
		...
		final ItemStack stack = new ItemStack(TropicItems.COCKTAILS.get(Drink.COCKTAIL));
		NbtCompound tag = new NbtCompound();
	...
	public ItemStack onFoodEaten(ItemStack itemstack, World world, PlayerEntity player) {
		...
		return new ItemStack(TropicItems.BAMBOO_MUG); //?? Unknow if this is right
	}
	...
	public ItemStack finishUsing(ItemStack stack, World worldIn, LivingEntity entityLiving) {
		...
		return new ItemStack(TropicItems.BAMBOO_MUG);
	}
