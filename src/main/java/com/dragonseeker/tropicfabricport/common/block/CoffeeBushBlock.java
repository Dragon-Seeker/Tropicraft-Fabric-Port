package com.dragonseeker.tropicfabricport.common.block;
...
public class CoffeeBushBlock extends CropBlock {
    ...
    protected ItemConvertible getSeedsItem() {
        return TropicItems.RAW_COFFEE_BEAN;
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult result) {
        if (state.get(AGE) == getMaxAge()) {
            ...
            ItemStack stack = new ItemStack(TropicItems.RAW_COFFEE_BEAN, count);
